...
namespace SalesWebMvc.Data
{
	public class SeedingService
	{
		...
		public void Seed()
		{
			...
			Seller s1 = new Seller(1, "Douglas", "douglas@gmail.com", 1000.0,new DateTime(1998, 4, 21), d1);
			Seller s2 = new Seller(2, "Vinicius Marques", "vinicius.marques@gmail.com", 1250,new DateTime(1999, 6, 25), d2);
			Seller s3 = new Seller(3, "Alessandro Rocha", "alessandro.rocha@gmail.com", 3000.0,new DateTime(1977, 1, 16), d3);
			Seller s4 = new Seller(5, "Bárbara", "barbara@gmail.com", 2850.0,new DateTime(2001, 3, 09), d4);
			Seller s5 = new Seller(6, "Alexei", "alexei@gmail.com", 4500.0,new DateTime(2001, 10, 15), d2);
			Seller s6 = new Seller(7, "Dayvison Rocha", "dayvison.pereira@gmail.com", 3500.0,new DateTime(2000, 9, 6), d1);
